...
import {View,Text,ToastAndroid, ScrollView, StatusBar} from 'react-native';

//Styles
import styles from './localFiles/calculator/styles.js';

//Custom Components
import NumberButtons from './localFiles/calculator/NumberButtons/index';
import HistoryView from './localFiles/calculator/HistoryView/index';
...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      <StatusBar barStyle = "light-content" hidden = {false} backgroundColor = "#b95cb8" translucent = { true } />
